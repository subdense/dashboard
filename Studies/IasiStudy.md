...
* Building footprints ground truth (2024): reference dataset
  ...
  * Process ManualBuildingFootprintsCorrection.md  --> TO BE CREATED. : In QGIS, the expert operator imports the building footprints generated by the FLAIR-HUB2BF process and make editions:  geometries modifications, add missing buildings, and remove false detections to ensure high geometric accuracy and completeness.
  * The resulting dataset serves as the reference (ground truth) dataset for assessing the quality of the automatically extracted building footprints (see process QualityAssessemntIndicatorsComputation.md) --> TO BE CREATED.
  * Source: The dataset is available as open data (link to be added).

* BuildingQualityMatchingLinksDataSet (2024): output dataset
  * This dataset is produced by the BuildingQualityDataSet(2024) (link to the process BuildingQualityDataSet description to be added).
